...
* availability[0].availableTime.daysOfWeek[0] = #mon
* availability[=].availableTime.daysOfWeek[+] = #tue
* availability[=].availableTime.daysOfWeek[+] = #wed
* availability[=].availableTime.availableStartTime = "09:00:00"
* availability[=].availableTime.availableEndTime = "15:30:00"
* availability[+].availableTime.daysOfWeek[0] = #thu
* availability[=].availableTime.daysOfWeek[+] = #fri
* availability[=].availableTime.availableStartTime = "09:00:00"
* availability[=].availableTime.availableEndTime = "12:00:00"
